...
BTCFLAGS = -I $(HEADFILE_PATH) -c $(DEBUGFLAG) $(OPTIMIXZED) $(CCSSEINS) $(BUILDTTEMP) -std=c99 -m64 -Wall -Wshadow -W -Wconversion -Wno-sign-conversion -fno-stack-protector -fomit-frame-pointer -fno-builtin -fno-common -fno-ident -ffreestanding -fno-stack-protector -fomit-frame-pointer -Wno-unused-parameter -Wunused-variable
